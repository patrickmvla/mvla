...
export function MediaEmbedElement(
  ...
  const { embed, focused, isTweet, isVideo, isYoutube, selected } =
    useMediaState({
        ...
        {isVideo && (
          <div
            className={cn(
              ...
              focused && selected && 'ring-1 ring-muted-foreground'
            )}
          >
            {isYoutube ? (
              <LiteYouTubeEmbed
        ...
        {isTweet && (
          <div
            className={cn(
              ...
              focused &&
                selected &&
                '[&_.react-tweet-theme]:ring-1 [&_.react-tweet-theme]:ring-muted-foreground'
            )}
          >
            <Tweet id={embed!.id!} />
          </div>
